...
In this repo I work with the [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#reacher) environment.
...
There are two options for solving this environment. 
...
3. Place the file in the DDPG GitHub repository folder and unzip (or decompress) the file. 

4. Start docker by running the command: `./start_docker`

5. Make sure conda environment `rl` is activated.

6. Start Jupyter Lab by running the command `./start_jupyter`.
...
### (To Do): Crawler Environment

A more difficult training task is the **Crawler** environment.
